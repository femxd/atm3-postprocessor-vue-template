...
exports.now = function (withoutMilliseconds) {
  var d = new Date(),
      str;
  str = [d.getHours(), d.getMinutes(), d.getSeconds()].join(':').replace(/\b\d\b/g, '0$&');
...
exports.debug = function (msg) {
  ...
  log('debug', (exports.now().grey || exports.now()) + ' ' + msg, exports.L_DEBUG);
};
 ...
 */
exports.on = {
  any: function any(type, msg) {},
  debug: function debug(msg) {
    process.stdout.write('\n ' + ('[DEBUG]'.grey || '[DEBUG]') + ' ' + msg + '\n');
  },
  notice: function notice(msg) {
    process.stdout.write('\n ' + '[INFO]'.cyan || '[INFO]' + ' ' + msg + '\n');
  },
  allan: function allan(msg) {
    process.stdout.write('\n ' + ('[allan]'.cyan || '[allan]') + ' ' + msg + '\n');
  },
  warning: function warning(msg) {
    process.stdout.write('\n ' + ('[WARNI]'.yellow || '[WARNI]') + ' ' + msg + '\n');
  },
